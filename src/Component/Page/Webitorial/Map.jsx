...
const MapSVGComponent = () => {
  const dispatch = useDispatch();
  const webitorial = useSelector((state) => state.webitorialReducer.country);
  ...
  const handleMouseOver = (e) => {
    ...
    document.getElementById("talkname").style.top = clientY - 60 + "px";
    document.getElementById("talkname").style.left = clientX + 10 + "px";

    document.querySelectorAll(".allPaths").forEach((country) => {
      country.style.fill = country.id === countryName ? "#941196" : "";
      country.style.transition = country.id === countryName ? "all 1s" : "";
    });

    document.getElementById("talkname").style.opacity = 1;
  ...
  const handleMouseLeave = () => {
    ...
    document.getElementById("talkname").style.opacity = 0;
  };
  ...
  return (
    <>
      ...
      <div className="container mx-auto px-6">
        <div className="text-h3 font-bold font-poppins mt-32">
          <Heading HeadingText="Select Webitorials by Country" />
        </div>

        <div className="py-6 flex flex-wrap gap-2 lg:gap-2">
          {webitorial.map(
            (country, index) =>
              // Check if country_id is not 4 or 11 before rendering
              country.country_id !== 4 && (
                <Link to={`/webinterviews/${country.country_name}`} key={index}>
                  <div className="bg-gray-200 border border-gray-300 px-2 lg:py-2 py- flex items-center justify-center cursor-pointer">
      ...
      <div className="map-section">
        ...
        >
          ...
          <Link
            to={`/webinterviews/${
              webitorial.length > 0 ? webitorial[8].country_name : ""
            }`}
            className="selected-country-class"
          ...
          <Link
            to={`/webinterviews/${
              webitorial.length > 0 ? webitorial[13].country_name : ""
            }`}
            className="selected-country-class"
            onMouseOver={handleMouseOver}
            onMouseLeave={handleMouseLeave}
          ...
          <Link
            to={`/webinterviews/${
              webitorial.length > 0 ? webitorial[2].country_name : ""
            }`}
            className="selected-country-class"
            onMouseOver={handleMouseOver}
            onMouseLeave={handleMouseLeave}
          ...
          <Link
            to={`/webinterviews/${
              webitorial.length > 0 ? webitorial[4].country_name : ""
            }`}
            className="selected-country-class"
            onMouseOver={handleMouseOver}
            onMouseLeave={handleMouseLeave}
          ...
          <Link
            to={`/webinterviews/${
              webitorial.length > 0 ? webitorial[7].country_name : ""
            }`}
            className="selected-country-class"
            onMouseOver={handleMouseOver}
            onMouseLeave={handleMouseLeave}
          ...
          <Link
            to={`/webinterviews/${
              webitorial.length > 0 ? webitorial[9].country_name : ""
            }`}
            className="selected-country-class"
            onMouseOver={handleMouseOver}
            onMouseLeave={handleMouseLeave}
          ...
          ></path>
           <Link
            to={`/webinterviews/${
              webitorial.length > 0 ? webitorial[12].country_name : ""
            }`}
            className="selected-country-class"
            onMouseOver={handleMouseOver}
            onMouseLeave={handleMouseLeave}
          ...
          <Link
            to={`/webinterviews/${
              webitorial.length > 0 ? webitorial[0].country_name : ""
            }`}
            className="selected-country-class"
            onMouseOver={handleMouseOver}
            onMouseLeave={handleMouseLeave}
          ...
          <Link
            to={`/webinterviews/${
              webitorial.length > 0 ? webitorial[11].country_name : ""
            }`}
            className="selected-country-class"
            onMouseOver={handleMouseOver}
            onMouseLeave={handleMouseLeave}
          ...
          <Link
            to={`/webinterviews/${
              webitorial.length > 0 ? webitorial[6].country_name : ""
            }`}
            className="selected-country-class"
            onMouseOver={handleMouseOver}
            onMouseLeave={handleMouseLeave}
          ...
          <Link
            to={`/webinterviews/${
              webitorial.length > 0 ? webitorial[10].country_name : ""
            }`}
            className="selected-country-class"
            onMouseOver={handleMouseOver}
            onMouseLeave={handleMouseLeave}
          ...
          <Link
            to={`/webinterviews/${
              webitorial.length > 0 ? webitorial[5].country_name : ""
            }`}
            className="selected-country-class"
            onMouseOver={handleMouseOver}
            onMouseLeave={handleMouseLeave}
          >
            ...
            ></path>
            <path
              className="Russian Federation RU"
          ...
          <Link
            to={`/webinterviews/${
              webitorial.length > 0 ? webitorial[1].country_name : ""
            }`}
            className="selected-country-class"
            onMouseOver={handleMouseOver}
            onMouseLeave={handleMouseLeave}
