...
const Webstories = () => {
    ...
    const itemsPerPage = 10; // Number of API cards to display per page
    console.log(stories.length);
    // console.log(stories.length / itemsPerPage);
    const totalPages = 3; // Assuming there are 5 pages in total (adjust as needed)
    ...
    useEffect(() => {
        ...
        fetchStories();
    }, [activePage]); // Fetch stories whenever activePage changes
                                ...
                                <li key={pageNumber + 1}>
                                    <button
                                        className={`flex items-center justify-center px-4 h-10 leading-tight ${
                                            pageNumber + 1 === activePage ? 'text-white bg-purple' : 'text-white '
